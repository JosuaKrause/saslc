...
public class Parser extends java_cup.runtime.lr_parser {
  ...
  public Parser(final java_cup.runtime.Scanner s) {super(s);}

  /** Constructor which sets the default scanner. */
  public Parser(final java_cup.runtime.Scanner s, final java_cup.runtime.SymbolFactory sf) {super(s,sf);}
  ...
  public final java_cup.runtime.Symbol CUP$Parser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
		...
		final Expr e = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = ListComp.guard(e); 
          ...
          case 63: // sc_part ::= NAME FROM expr 
            {
              ListComp.Part RESULT =null;
		final String n = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-2)).value;
		final Expr e = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		...
		final ListComp.Part p = (ListComp.Part)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new ListComp(p); 
          ...
          case 60: // listcmp ::= sc_part COMMA listcmp 
            {
              ListComp RESULT =null;
		final ListComp.Part p = (ListComp.Part)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-2)).value;
		final ListComp lc = (ListComp)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = lc.add(p); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("listcmp",16, RESULT);
            }
          return CUP$Parser$result;
		 ...
		 RESULT = null; 
          ...
          case 58: // e_to ::= expr BRACK_R 
            {
              Expr RESULT =null;
		final Expr e = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = e; 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("e_to",14, RESULT);
            }
          return CUP$Parser$result;
		...
		final Expr e = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = BuiltIn.CONS.app(e, BuiltIn.NIL); 
          ...
          case 55: // s_list ::= expr COMMA s_list 
            {
              Expr RESULT =null;
		final Expr e = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-2)).value;
		final Expr l = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		...
		final Expr e = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = BuiltIn.CONS.app(e, BuiltIn.NIL); 
          ...
          case 50: // list ::= expr SEMI listcmp BRACK_R 
            {
              Expr RESULT =null;
		final Expr v = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-3)).value;
		final ListComp c = (ListComp)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = c.finish(v); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("list",12, RESULT);
            }
          return CUP$Parser$result;
		...
		final Expr[] l = (Expr[])((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = l.length == 2
          ...
          case 48: // list ::= expr ELLIPSE e_to 
            {
              Expr RESULT =null;
		final Expr f = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-2)).value;
		final Expr t = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		...
		final Expr l = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = l; 
          ...
          case 46: // constant ::= CHAR 
            {
              Expr RESULT =null;
		final Character c = (Character)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = Char.valueOf(c); 
          ...
          case 45: // constant ::= STR 
            {
              Expr RESULT =null;
		final String s = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = Str.fromString(s); 
          ...
          case 44: // constant ::= BLN 
            {
              Expr RESULT =null;
		final Boolean b = (Boolean)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = Bool.valueOf(b); 
          ...
          case 43: // constant ::= NUM 
            {
              Expr RESULT =null;
		final BigInteger n = (BigInteger)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		...
		final Expr e = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new Lambda(n, e); 
          ...
          case 41: // lambdaexpr ::= NAME lambdaexpr 
            {
              Expr RESULT =null;
		final String n = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		final Expr l = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		...
		final Expr e = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = e; 
          ...
          case 39: // simple ::= BRACE_L lambdaexpr BRACE_R 
            {
              Expr RESULT =null;
		final Expr l = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = l; 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("simple",10, RESULT);
            }
          return CUP$Parser$result;
          ...
          case 38: // simple ::= constant 
            {
              Expr RESULT =null;
		final Expr c = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = c; 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("simple",10, RESULT);
            }
          return CUP$Parser$result;
          ...
          case 37: // simple ::= NAME 
            {
              Expr RESULT =null;
		final String n = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = Name.valueOf(n); 
          ...
          case 36: // comb ::= simple 
            {
              Expr RESULT =null;
		final Expr s = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = s; 
          ...
          case 35: // comb ::= comb simple 
            {
              Expr RESULT =null;
		final Expr c = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		final Expr s = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
          ...
          case 34: // infixexpr ::= condexpr COMP condexpr 
            {
              Expr RESULT =null;
		final Expr f = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-2)).value;
		final Expr g = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 final Name x = Name.createName();
          ...
          case 33: // infixexpr ::= condexpr INAME condexpr 
            {
              Expr RESULT =null;
		final Expr x = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-2)).value;
		final String n = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		final Expr y = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		...
		final Expr y = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = BuiltIn.PLUS.app(x, y); 
          ...
          case 16: // prefixexpr ::= UMINUS condexpr 
            {
              Expr RESULT =null;
		final Expr o = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		...
		final Expr c = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = c; 
          ...
          case 13: // condexpr ::= infixexpr 
            {
              Expr RESULT =null;
		final Expr i = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = i; 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("condexpr",5, RESULT);
            }
          return CUP$Parser$result;
          ...
          case 12: // condexpr ::= prefixexpr 
            {
              Expr RESULT =null;
		final Expr p = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = p; 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("condexpr",5, RESULT);
            }
          return CUP$Parser$result;
          ...
          case 11: // condexpr ::= IF expr THEN expr ELSE expr 
            {
              Expr RESULT =null;
		final Expr i = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-4)).value;
		final Expr t = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-2)).value;
		final Expr e = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
          ...
          case 10: // defs ::= NAME def 
            {
              Module RESULT =null;
		final String n = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		final Expr d = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = parser.addDefinition(new Module(false), n, d); 
          ...
          case 9: // defs ::= NAME def COMMA defs 
            {
              Module RESULT =null;
		final String n = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-3)).value;
		final Expr d = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-2)).value;
		final Module ds = (Module)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		...
		final Expr c = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = c; 
          ...
          case 7: // expr ::= LET defs IN expr 
            {
              Expr RESULT =null;
		final Module ds = (Module)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-2)).value;
		final Expr e = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		...
		final Expr e = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 ...
		 RESULT = new Module(true); 
          ...
          case 3: // module ::= error SEMI module 
            {
              Module RESULT =null;
		final Module m = (Module)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		...
		final Module m = (Module)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = parser.addDefinition(m, n, d); 
          ...
          case 1: // $START ::= sasl EOF 
            {
              Object RESULT =null;
		final Module start_val = (Module)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		RESULT = start_val;
